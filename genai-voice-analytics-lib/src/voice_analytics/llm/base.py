...
LIBRARY_NAME = "genai-voice-analytics-lib"

#: Attached to gateway calls so usage can be attributed downstream.
DEFAULT_METADATA = {"library": LIBRARY_NAME, "mode": "api"}
BATCH_METADATA = {"library": LIBRARY_NAME, "mode": "batch"}
