...
#: Personal information could not be removed, so the run was stopped rather
#: than continuing with unanonymized text. Distinct from PROCESSING_FAILED
#: because it is a compliance-control failure and usually wants its own alert.
ANONYMIZATION_FAILED = 9
