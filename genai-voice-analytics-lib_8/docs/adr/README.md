...
| [0005](0005-structured-logging-for-orchestrated-pods.md) | Logs are written for people; where try/except belongs | Accepted |
| [0006](0006-what-was-not-ported.md) | What was not ported from the originating service | Accepted |
...
- [0007](0007-persistence-is-a-separate-package.md) -- persistence is a separate package, not part of the library
